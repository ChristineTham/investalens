...
<Dialog.Root>
  ...
  <Dialog.Portal>
    ...
    <Dialog.Overlay className="data-[state=closed]:animate-out data-[state=open]:animate-in" />
    <Dialog.Content className="data-[state=closed]:fade-out data-[state=open]:fade-in" />
  </Dialog.Portal>
</Dialog.Root>;
```

...
export function HoldingDetailClient({
  ...
  const [data, setData] = useState<HoldingDetailData | null>(null);
  ...
  useEffect(() => {
    ...
    fetch(
      `/api/v1/portfolios/${portfolioId}/holdings/${holdingId}/detail?${params}`
    )
      .then((r) => (r.ok ? r.json() : null))
      .then((d: HoldingDetailData | null) => {
  ...
  }, [portfolioId, holdingId, range, benchmark, requestKey]);

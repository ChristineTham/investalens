...
const SEARCH_INDEX: Record<string, string[]> = {
  ...
  "models": ["model", "models", "weights", "constituents", "instantiation", "rebalance", "benchmark", "vdhg", "dhhf", "target", "notional", "lookback"],
  "accounts": ["accounts", "cash", "bank", "balance", "ofx", "qfx", "qif", "statement", "import", "category", "categorise", "reconcile", "reconciliation", "split", "franking", "debit card", "bsb", "virtual", "ledger", "net worth", "settlement", "commbank", "nab", "anz", "westpac", "ing", "macquarie"],
